...
usuarios = {}       # {username: contraseña}
grupos = {}         # {nombre_grupo: {"creadora": str, "miembros": set(), "posts": list}}
invitaciones = {}   # {username: set(nombre_grupo)} - Invitaciones a clubs
amigos = {}         # {username: set(amigo_username)} - Lista de amigas
chats_privados = {} # {(user1, user2): list} - Mensajes privados

usuario_actual = None

# === DISEÑO ROSA BRILLANTE ===
ESTILO_BASE = """
<!DOCTYPE html>
<html>
<head>
...
# De esta forma, aunque se apague el servidor, NADA se borra.
...
# Cargar la base de datos real al iniciar
...
# Lista de stickers divertidos que se pueden usar
STICKERS = ["💖", "✨", "👑", "💅", "🦄", "🦄✨", "🎀", "🦊", "🌸", "🍕", "🧸", "🍰", "🍭", "👽", "🦋", "💘"]

# === DISEÑO ROSA BRILLANTE (HTML/CSS) ===
ESTILO_BASE = """
<!DOCTYPE html>
<html>
<head>
